      ...
      <div className="min-h-screen bg-[#30054A] text-white ">
        ...
        >
          ...
          <div className="flex flex-col items-center pb-12 mb-12">
            ...
            <div className="flex flex-wrap justify-center gap-8 my-4">
              {awaImages.map((img, index) => (
                ...
                >
                  <img
                    className="2xl:w-[250px] [@media(min-width:1910px)]:w-[370px] [@media(min-width:1910px)]:h-[370px] [@media(min-width:2500px)]:w-[550px] [@media(min-width:2500px)]:h-[550px]  w-[200px] 2xl:h-[250px] object-cover rounded-md 
          ...
          <div className="mt-16 flex flex-col items-center pb-12 mb-12 w-[100%] py-12 bg-[#4f1b72]">
            ...
            <div className="flex flex-wrap justify-center gap-8 my-4">
              {fortniteImages.map((img, index) => (
                ...
                >
                  <img
                    className="2xl:w-[250px] [@media(min-width:1910px)]:w-[500px] [@media(min-width:1910px)]:h-[500px] w-[200px] 2xl:h-[250px]  [@media(min-width:2500px)]:w-[550px] [@media(min-width:2500px)]:h-[550px] object-cover rounded-md 
                    shadow-[0_4px_15px_#FED03B]/50"
                    src={img}
          ...
          <div className="mt-16 flex flex-col items-center">
           {/* PlayStation + Voltech Section */}
<div className="mt-16 flex flex-col items-center pb-12 mb-12 w-[100%] ">
  <h3
    className="h-[60px] flex items-center justify-center text-gold 
    text-2xl sm:text-3xl md:text-3xl xl:text-4xl 2xl:text-4xl
    [@media(min-width:1920px)]:text-3xl font-bold my-6 text-center"
  ...
  <div className="flex flex-wrap justify-center gap-8 my-4">
    {[...playStationImages, ...voltechFPSImages].map((img, index) => (
      ...
      >
        <img
          className="2xl:w-[250px] [@media(min-width:1910px)]:w-[500px] [@media(min-width:1910px)]:h-[500px] 
